...
const CarouselPrevious = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <Button ref={ref} className={cn("absolute h-8 w-8 rounded-full -left-12 top-1/2 -translate-y-1/2", className)} disabled={!canScrollPrev} onClick={scrollPrev} {...props}>
...
const CarouselNext = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <Button ref={ref} className={cn("absolute h-8 w-8 rounded-full -right-12 top-1/2 -translate-y-1/2", className)} disabled={!canScrollNext} onClick={scrollNext} {...props}>
